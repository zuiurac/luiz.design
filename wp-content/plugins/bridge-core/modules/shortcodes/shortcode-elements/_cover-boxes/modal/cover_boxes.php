...
<form id="qode_shortcode_form" name="qode_shortcode_form" method="post" action="">
    <div class="input">
        <label><?php esc_html_e( 'Active element', 'bridge-core' ); ?></label>
        <input name="active_element" id="active_element" value="" maxlength="100" size="55" />
    </div>
	<div class="input">
		<label><?php esc_html_e( 'Image 1', 'bridge-core' ); ?></label>
	...
	<div class="input">
		<label><?php esc_html_e( 'Title 1', 'bridge-core' ); ?></label>
		<input name="title1" id="title1" value="" maxlength="100" size="55" />
	</div>
	<div class="input">
		<label><?php esc_html_e( 'Title Color 1', 'bridge-core' ); ?></label>
		<div class="colorSelector"><div style=""></div></div>
		<input name="title_color1" id="title_color1" value="" maxlength="12" size="12" />
	</div>
	<div class="input">
		<label><?php esc_html_e( 'Text 1', 'bridge-core' ); ?></label>
		<input name="text1" id="text1" value="" size="55" />
	</div>
  	<div class="input">
		<label><?php esc_html_e( 'Text Color 1', 'bridge-core' ); ?></label>
		<div class="colorSelector"><div style=""></div></div>
		<input name="text_color1" id="text_color1" value="" maxlength="12" size="12" />
	</div>
	<div class="input">
    	<label><?php esc_html_e( 'Link 1', 'bridge-core' ); ?></label>
		<input name="link1" id="link1" value="" size="55" />
	</div>
	<div class="input">
    	<label><?php esc_html_e( 'Link label 1', 'bridge-core' ); ?></label>
		<input name="link_label1" id="link_label1" value="" size="55" />
	</div>
	<div class="input">
    	<label><?php esc_html_e( 'Target 1', 'bridge-core' ); ?></label>
	...
	<div class="input">
		<label><?php esc_html_e( 'Image 2', 'bridge-core' ); ?></label>
		<input id="image2" type="text" name="image2" class="popup_image" value="" size="55" />
		<input class="upload_button" type="button" value="Upload file" id="popup_image_button">
	</div>
	<div class="input">
		<label><?php esc_html_e( 'Title 2', 'bridge-core' ); ?></label>
		<input name="title2" id="title2" value="" maxlength="100" size="55" />
	</div>
	<div class="input">
		<label><?php esc_html_e( 'Title Color 2', 'bridge-core' ); ?></label>
		<div class="colorSelector"><div style=""></div></div>
		<input name="title_color2" id="title_color2" value="" maxlength="12" size="12" />
	</div>
	<div class="input">
    <label><?php esc_html_e( 'Text 2', 'bridge-core' ); ?></label>
		<input name="text2" id="text2" value="" size="55" />
	</div>
	<div class="input">
		<label><?php esc_html_e( 'Text Color 2', 'bridge-core' ); ?></label>
		<div class="colorSelector"><div style=""></div></div>
		<input name="text_color2" id="text_color2" value="" maxlength="12" size="12" />
	</div>
	<div class="input">
    	<label><?php esc_html_e( 'Link 2', 'bridge-core' ); ?></label>
		<input name="link2" id="link2" value="" size="55" />
	</div>
	<div class="input">
    	<label><?php esc_html_e( 'Link label 2', 'bridge-core' ); ?></label>
		<input name="link_label2" id="link_label2" value="" size="55" />
	</div>
	<div class="input">
    	<label><?php esc_html_e( 'Target 2', 'bridge-core' ); ?></label>
      	<select name="target2" id="target2">
      		<option value="_self"><?php esc_html_e( 'Self', 'bridge-core' ); ?></option>
			<option value="_blank"><?php esc_html_e( 'Blank', 'bridge-core' ); ?></option>
		 	<option value="_parent"><?php esc_html_e( 'Parent', 'bridge-core' ); ?></option>
		 	<option value="_top"><?php esc_html_e( 'Top', 'bridge-core' ); ?></option>
		</select>
	</div>
	<div class="input">
		<label><?php esc_html_e( 'Image 3', 'bridge-core' ); ?></label>
		<input id="image3" type="text" name="image3" class="popup_image" value="" size="55" />
		<input class="upload_button" type="button" value="Upload file" id="popup_image_button">
	</div>
	<div class="input">
		<label><?php esc_html_e( 'Title 3', 'bridge-core' ); ?></label>
		<input name="title3" id="title3" value="" maxlength="100" size="55" />
	</div>
	<div class="input">
		<label><?php esc_html_e( 'Title Color 3', 'bridge-core' ); ?></label>
		<div class="colorSelector"><div style=""></div></div>
		<input name="title_color3" id="title_color3" value="" maxlength="12" size="12" />
	</div>
	<div class="input">
    	<label><?php esc_html_e( 'Text 3', 'bridge-core' ); ?></label>
		<input name="text3" id="text3" value="" size="55" />
	</div>
	<div class="input">
		<label><?php esc_html_e( 'Text Color 3', 'bridge-core' ); ?></label>
		<div class="colorSelector"><div style=""></div></div>
		<input name="text_color3" id="text_color3" value="" maxlength="12" size="12" />
	</div>
	<div class="input">
    <label><?php esc_html_e( 'Link 3', 'bridge-core' ); ?></label>
		<input name="link3" id="link3" value="" size="55" />
	</div>
	<div class="input">
    	<label><?php esc_html_e( 'Link label 3', 'bridge-core' ); ?></label>
		<input name="link_label3" id="link_label3" value="" size="55" />
	</div>
	<div class="input">
    	<label><?php esc_html_e( 'Target 3', 'bridge-core' ); ?></label>
