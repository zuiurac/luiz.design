            ...
            if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post();
                ...
                if($hover_type == 'default') {
                    ...
                    if($lightbox == "yes" || $portfolio_qode_like == "on" || $view_button !== "no"){
                        ...
                        if($view_button !== "no"){
                            $html .= "<a itemprop='url' class='preview qbutton small white' href='" . $portfolio_link . "' target='".$target."'>" . esc_html__('saiba mais', 'bridge-core'). "</i></a>";
                        }
                ...
                */
                ...
                if($hover_type == 'default') {
                    ...
                    if($lightbox == "yes" || $portfolio_qode_like == "on" || $view_button !== "no"){
                        ...
                        if($view_button !== "no"){
                            $html .= "<a itemprop='url' class='preview qbutton small white' href='" . $portfolio_link . "' target='".$target."'>" . esc_html__('saiba mais', 'bridge-core'). "</a>";
                        }
                        if ($portfolio_qode_like == "on") {
                            $html .= "<span class='portfolio_like qbutton small white'>";
                            $portfolio_project_id = get_the_ID();
